...
$.get("json/PRODUT.json", function (data) {
    ...
    if(parametros['grupo'] === undefined) {
        alert('Grupo não encontrada');
        ...
        $.get("json/PRODUT.json", function (data) {
            ...
            let i = 0;
            let grupoSelecionado = dataJsonProduto.data.filter(produto => produto.GRUPO == parametros['grupo']);
            linhaProdutos.push(grupoSelecionado);
